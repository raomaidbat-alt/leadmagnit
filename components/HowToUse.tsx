...
const STEPS = [
  ...
  },
  {
    ...
    description: "Сначала заполните первые 3 промпта — это основа. Без позиционирования и анализа конкурентов остальные промпты будут менее эффективны."
  },
  {
    title: "Копируйте в любую ИИ",
    description: "Нажмите 'Копировать' и вставьте текст в любую нейросеть (ChatGPT, Claude, Gemini, Google AI Studio и др.). Добавьте свои данные в квадратные скобки [ ]."
  },
  {
    title: "Следуйте 30-дневному плану",
    description: "Не пытайтесь внедрить всё за один день. Используйте по одному промпту в день, чтобы выстроить систему последовательно."
  }
];
